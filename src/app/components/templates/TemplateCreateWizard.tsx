...
export default function TemplateCreateWizard({
  ...
  return (
    <div className="space-y-6 rounded-[2rem] border border-[var(--line)] bg-[var(--surface)] p-6 shadow-[0_18px_34px_rgba(30,90,72,0.08)]">
      <div>
        <p className="text-sm uppercase tracking-[0.22em] text-[var(--lagoon-deep)]">Assistant de création</p>
      ...
      {step === 3 ? (
        <div className="grid gap-4">
          <div>
            <p className="mb-3 text-sm font-semibold text-[var(--sea-ink)]">Variables</p>
            <div className="space-y-4">
              {variables.map((variable, index) => (
                <div key={variable.name} className="grid gap-2 rounded-3xl border border-[var(--line)] bg-[var(--surface-strong)] p-4">
                  <input
                    value={variable.name}
          ...
          <label className="grid gap-2 text-sm font-semibold text-[var(--sea-ink)]">
            ...
            <textarea
              ...
              className="min-h-[180px] rounded-[1.75rem] border border-[var(--line)] bg-[var(--surface-strong)] px-4 py-4 text-sm text-[var(--sea-ink)] outline-none font-mono"
